...
public class LawyerHelpLevel3Adapter extends RecyclerView.Adapter<LawyerHelpLevel3Adapter.ViewHolder> {

    List<Level3> addressListItem;
    Context context;

    public LawyerHelpLevel3Adapter(List<Level3> addressListItem, Context context) {
