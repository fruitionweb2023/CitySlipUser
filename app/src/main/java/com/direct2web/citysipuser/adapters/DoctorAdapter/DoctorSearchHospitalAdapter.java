...
public class DoctorSearchHospitalAdapter extends RecyclerView.Adapter<DoctorSearchHospitalAdapter.ViewHolder> {

    List<WishListBusiness> businessList1;
    Context context;

    public DoctorSearchHospitalAdapter(List<WishListBusiness> businessList1, Context context) {
