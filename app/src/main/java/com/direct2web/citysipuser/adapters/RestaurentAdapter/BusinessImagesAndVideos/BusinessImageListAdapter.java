...
public class BusinessImageListAdapter extends RecyclerView.Adapter<BusinessImageListAdapter.ViewHolder>{

    List<Image> imageList;
    Context context;


    public BusinessImageListAdapter(List<Image> imageList, Context context) {
