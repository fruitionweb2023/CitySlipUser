...
public class InsurenceVideoListAdapter extends RecyclerView.Adapter<InsurenceVideoListAdapter.ViewHolder>{
    ...
    public InsurenceVideoListAdapter(Context context, List<Video> stringArrayList) {
