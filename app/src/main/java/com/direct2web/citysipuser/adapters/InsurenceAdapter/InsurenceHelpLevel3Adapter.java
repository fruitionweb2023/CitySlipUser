...
public class InsurenceHelpLevel3Adapter extends RecyclerView.Adapter<InsurenceHelpLevel3Adapter.ViewHolder> {

    List<Level3> addressListItem;
    Context context;

    public InsurenceHelpLevel3Adapter(List<Level3> addressListItem, Context context) {
