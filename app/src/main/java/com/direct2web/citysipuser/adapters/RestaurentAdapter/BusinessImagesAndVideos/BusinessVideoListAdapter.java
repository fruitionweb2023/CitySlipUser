package com.direct2web.citysipuser.adapters.RestaurentAdapter.BusinessImagesAndVideos;
...
public class BusinessVideoListAdapter extends RecyclerView.Adapter<BusinessVideoListAdapter.ViewHolder>{
    ...
    public BusinessVideoListAdapter(Context context, List<Video> stringArrayList) {
