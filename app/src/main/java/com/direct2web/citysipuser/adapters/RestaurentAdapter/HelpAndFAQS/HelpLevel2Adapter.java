package com.direct2web.citysipuser.adapters.RestaurentAdapter.HelpAndFAQS;
...
public class HelpLevel2Adapter extends RecyclerView.Adapter<HelpLevel2Adapter.ViewHolder> {

    List<Level2> addressListItem;
    Context context;
    OnItemClickListner itemClicked;

    public HelpLevel2Adapter(List<Level2> addressListItem, Context context, OnItemClickListner itemClicked) {
