...
public class DoctorHelpLevel2Adapter extends RecyclerView.Adapter<DoctorHelpLevel2Adapter.ViewHolder> {

    List<Level2> addressListItem;
    Context context;
    OnItemClickListner itemClicked;

    public DoctorHelpLevel2Adapter(List<Level2> addressListItem, Context context, OnItemClickListner itemClicked) {
