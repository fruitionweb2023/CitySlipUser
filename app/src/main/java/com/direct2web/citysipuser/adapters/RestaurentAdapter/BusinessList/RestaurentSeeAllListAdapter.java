...
public class RestaurentSeeAllListAdapter extends RecyclerView.Adapter<RestaurentSeeAllListAdapter.ViewHolder> {
    ...
    public RestaurentSeeAllListAdapter(List<RecommendedList> businessList, Context context, OnItemClickListner itemClicked) {
