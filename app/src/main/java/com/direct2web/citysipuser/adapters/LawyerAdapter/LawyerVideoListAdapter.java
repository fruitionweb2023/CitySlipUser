...
public class LawyerVideoListAdapter extends RecyclerView.Adapter<LawyerVideoListAdapter.ViewHolder>{
    ...
    public LawyerVideoListAdapter(Context context, List<Video> stringArrayList) {
