...
import com.direct2web.citysipuser.databinding.RawAddressListBinding;
...
public class AddressListAdapter   extends RecyclerView.Adapter<AddressListAdapter.ViewHolder> {
    ...
    public AddressListAdapter(List<Address> addressListItem, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RawAddressListBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_address_list, parent, false);
    ...
    public class ViewHolder   extends RecyclerView.ViewHolder  {
        ...
        RawAddressListBinding binding;

        public ViewHolder(@NonNull RawAddressListBinding itemView) {
