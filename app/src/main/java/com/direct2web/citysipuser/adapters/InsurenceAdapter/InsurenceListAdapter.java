...
public class InsurenceListAdapter extends RecyclerView.Adapter<InsurenceListAdapter.ViewHolder> {
    ...
    public InsurenceListAdapter(List<Service> businessList, Context context, OnItemClickListner itemClicked) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RawInsurenceRecommandedListBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_insurence_recommanded_list, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        RawInsurenceRecommandedListBinding binding;

        public ViewHolder(@NonNull RawInsurenceRecommandedListBinding itemView) {
