...
public class DoctorAddressListAdapter extends RecyclerView.Adapter<DoctorAddressListAdapter.ViewHolder> {
    ...
    public DoctorAddressListAdapter(List<Address> addressListItem, Context context) {
