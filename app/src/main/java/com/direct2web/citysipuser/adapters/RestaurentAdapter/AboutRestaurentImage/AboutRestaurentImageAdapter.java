package com.direct2web.citysipuser.adapters.RestaurentAdapter.AboutRestaurentImage;
...
public class AboutRestaurentImageAdapter extends RecyclerView.Adapter<AboutRestaurentImageAdapter.ViewHolder> {

    List<Image> imageList;
    Context context;
    OnImageClickedListner onImageClickedListner;

    public AboutRestaurentImageAdapter(List<Image> offerList, Context context,OnImageClickedListner onImageClickedListner) {
        this.imageList = offerList;
