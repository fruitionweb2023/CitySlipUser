...
public class InsurenceHelpAdapter extends RecyclerView.Adapter<InsurenceHelpAdapter.ViewHolder> {

    List<Level1> addressListItem;
    Context context;
    OnItemClickListner itemClicked;

    public InsurenceHelpAdapter(List<Level1> addressListItem, Context context, OnItemClickListner itemClicked) {
