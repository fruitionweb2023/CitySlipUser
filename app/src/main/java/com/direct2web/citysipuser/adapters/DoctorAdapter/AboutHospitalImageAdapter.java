...
public class AboutHospitalImageAdapter extends RecyclerView.Adapter<AboutHospitalImageAdapter.ViewHolder> {

    List<Image> imageList;
    Context context;
    OnImageClickedListner onImageClickedListner;

    public AboutHospitalImageAdapter(List<Image> imageList, DoctorHospitalReadMoreActivity context,OnImageClickedListner onImageClickedListner) {
