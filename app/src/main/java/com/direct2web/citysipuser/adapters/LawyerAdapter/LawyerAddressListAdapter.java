...
public class LawyerAddressListAdapter extends RecyclerView.Adapter<LawyerAddressListAdapter.ViewHolder> {
    ...
    public LawyerAddressListAdapter(List<Address> addressListItem, Context context) {
