...
public class LawyerDetailsAddAdapter extends RecyclerView.Adapter<LawyerDetailsAddAdapter.ViewHolder>{

    List<Service> itemList;
    Context context;
    OnAddButtonClicked buttonClicked;

    public LawyerDetailsAddAdapter(List<Service> itemList, Context context, OnAddButtonClicked buttonClicked) {
