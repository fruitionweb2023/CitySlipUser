...
public class DoctorFavouriteHospitalAdapter extends RecyclerView.Adapter<DoctorFavouriteHospitalAdapter.ViewHolder> {

    List<WishListBusiness> businessList1;
    Context context;

    public DoctorFavouriteHospitalAdapter(List<WishListBusiness> businessList1, Context context) {
