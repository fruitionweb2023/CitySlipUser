...
public class FavouriteRestaurentAdapter  extends RecyclerView.Adapter<FavouriteRestaurentAdapter.ViewHolder> {

    List<WishListBusinessItem> businessList1;
    Context context;

    public FavouriteRestaurentAdapter(List<WishListBusinessItem> businessList1, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        WishListBusinessItem restaurent = businessList1.get(position);
    ...
    public void filterdeList(ArrayList<WishListBusinessItem> filterList) {
