...
public class LawyerHelpAdapter extends RecyclerView.Adapter<LawyerHelpAdapter.ViewHolder> {

    List<Level1> addressListItem;
    Context context;
    OnItemClickListner itemClicked;

    public LawyerHelpAdapter(List<Level1> addressListItem, Context context, OnItemClickListner itemClicked) {
