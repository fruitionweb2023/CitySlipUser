...
public class InsurenceFavouriteAdapter extends RecyclerView.Adapter<InsurenceFavouriteAdapter.ViewHolder> {

    List<WishListBusiness> businessList1;
    Context context;

    public InsurenceFavouriteAdapter(List<WishListBusiness> businessList1, Context context) {
