...
public class HelpLevel3Adapter extends RecyclerView.Adapter<HelpLevel3Adapter.ViewHolder> {

    List<Level3> addressListItem;
    Context context;

    public HelpLevel3Adapter(List<Level3> addressListItem, Context context) {
