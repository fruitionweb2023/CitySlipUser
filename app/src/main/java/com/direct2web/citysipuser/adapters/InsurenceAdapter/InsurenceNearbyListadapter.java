...
public class InsurenceNearbyListadapter extends RecyclerView.Adapter<InsurenceNearbyListadapter.ViewHolder>{
    ...
    public InsurenceNearbyListadapter(List<Agent> businessListNearBy, Context context, OnItemClickListnerNearBy itemClicked) {
