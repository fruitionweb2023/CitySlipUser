...
public class LawyerRatingAdapter extends RecyclerView.Adapter<LawyerRatingAdapter.ViewHolder> {

    List<Review> doctorReview ;
    Context context;


    public LawyerRatingAdapter(List<Review> doctorReview, Context context) {
