...
public class LawyerListAdapter extends RecyclerView.Adapter<LawyerListAdapter.ViewHolder> {
    ...
    public LawyerListAdapter(List<Recommended> businessList, Context context, OnItemClickListner itemClicked) {
