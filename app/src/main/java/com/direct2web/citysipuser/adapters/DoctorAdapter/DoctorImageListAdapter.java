...
public class DoctorImageListAdapter extends RecyclerView.Adapter<DoctorImageListAdapter.ViewHolder>{

    List<Image> imageList;
    Context context;


    public DoctorImageListAdapter(List<Image> imageList, Context context) {
