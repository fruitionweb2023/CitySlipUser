...
public class LawyerSearchHospitalAdapter extends RecyclerView.Adapter<LawyerSearchHospitalAdapter.ViewHolder> {

    List<WishListBusiness> businessList1;
    Context context;

    public LawyerSearchHospitalAdapter(List<WishListBusiness> businessList1, Context context) {
