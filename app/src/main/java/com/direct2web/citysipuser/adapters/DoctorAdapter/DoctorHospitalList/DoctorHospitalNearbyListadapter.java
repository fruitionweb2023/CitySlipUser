...
public class DoctorHospitalNearbyListadapter extends RecyclerView.Adapter<DoctorHospitalNearbyListadapter.ViewHolder>{
    ...
    public DoctorHospitalNearbyListadapter(List<NearBy> businessListNearBy, Context context, OnItemClickListnerNearBy itemClicked) {
