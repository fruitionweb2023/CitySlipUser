...
import com.direct2web.citysipuser.databinding.RawInsurenceCartItemBinding;
...
public class InsurenceCartAdapter extends RecyclerView.Adapter<InsurenceCartAdapter.ViewHolder> {
    ...
    public InsurenceCartAdapter(List<Cart> cartItems, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RawInsurenceCartItemBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_insurence_cart_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        RawInsurenceCartItemBinding binding;

        public ViewHolder(@NonNull RawInsurenceCartItemBinding itemView) {
