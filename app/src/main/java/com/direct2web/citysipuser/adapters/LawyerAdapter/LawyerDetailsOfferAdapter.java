...
public class LawyerDetailsOfferAdapter extends RecyclerView.Adapter<LawyerDetailsOfferAdapter.ViewHolder> {

    List<Offer> offerList;
    Context context;

    public LawyerDetailsOfferAdapter(List<Offer> offerList, Context context) {
