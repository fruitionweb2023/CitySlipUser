...
public class InsurenceHelpLevel2Adapter extends RecyclerView.Adapter<InsurenceHelpLevel2Adapter.ViewHolder> {

    List<Level2> addressListItem;
    Context context;
    OnItemClickListner itemClicked;

    public InsurenceHelpLevel2Adapter(List<Level2> addressListItem, Context context, OnItemClickListner itemClicked) {
